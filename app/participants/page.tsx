  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Add and manage participants for your Secret Santa exchange. Ensure everyone has a wishlist and budget set for a fun and organized gift exchange." />
